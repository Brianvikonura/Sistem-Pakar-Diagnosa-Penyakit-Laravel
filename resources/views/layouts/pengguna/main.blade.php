...
<head>
    ...
    <title>Sistem Pakar Diagnosa Penyakit oleh Brian</title>
    ...
    <!-- Logo -->
    <link rel="shortcut icon" type="image/x-icon" href="https://www.freepik.com/icon/bold-option_6162519#fromView=search&term=b+logo&page=1&position=13">
